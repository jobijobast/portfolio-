...
const SphereImageGrid: React.FC<SphereImageGridProps> = ({
  ...
  const renderImageNode = useCallback((image: ImageData, index: number) => {
    ...
    return (
      ...
      >
        <div className="relative w-full h-full rounded-lg overflow-hidden shadow-lg border-2 border-primary/30 hover:border-primary/60 transition-colors">
          <img
            src={image.src}
            alt={image.alt}
  ...
  const renderSpotlightModal = () => {
    ...
    return (
      ...
      >
        <div
          className="bg-card rounded-xl max-w-2xl w-full overflow-hidden border border-border"
        ...
        >
          <div className="relative aspect-video">
            ...
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-4 right-4 w-10 h-10 bg-background/90 rounded-full text-foreground flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all cursor-pointer"
            >
              <X size={20} />
            </button>
          </div>
  ...
  if (!isMounted) {
    return (
      <div
        className="bg-secondary/50 rounded-lg animate-pulse flex items-center justify-center"
  ...
  if (!images.length) {
    return (
      <div
        className="bg-secondary/30 rounded-lg border-2 border-dashed border-border flex items-center justify-center"
        style={{ width: containerSize, height: containerSize }}
      >
